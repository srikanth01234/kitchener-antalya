...
export default function LegacySection() {
  return (
    <section id="about" className="relative w-full min-h-[700px] flex flex-col lg:flex-row overflow-hidden bg-[#faf6f0] border-b border-[#2d2219]/10">
      
      {/* LEFT SIDE: Text Content */}
      <div className="relative w-full lg:w-[45%] flex flex-col justify-center px-6 md:px-12 lg:pl-[calc((100vw-min(100vw,1440px))/2+4rem)] lg:pr-16 py-20 lg:py-24 z-20 bg-[#faf6f0]">
        
        {/* Faded Watermark Background Text */}
        <div className="absolute top-12 left-10 lg:top-20 lg:left-[calc((100vw-min(100vw,1440px))/2+2rem)] opacity-[0.04] pointer-events-none select-none z-0">
        ...
        <div className="relative z-10 flex flex-col items-start max-w-xl mx-auto lg:mx-0 w-full">
          ...
          {/* Over-title */}
          <div className="flex items-center gap-3 text-[#9c1010] font-extrabold tracking-[3px] text-xs uppercase mb-6">
          ...
          {/* Main Title */}
          <h2 className="font-serif text-5xl md:text-6xl lg:text-[4.5rem] font-medium text-[#2d2219] leading-[1.1] mb-6 tracking-tight">
            More Than a <br className="hidden sm:block" />
            Restaurant, <br className="hidden sm:block" />
            <span className="text-[#9c1010]">It's a Legacy</span>
            <span className="inline-block text-[#9c1010] ml-3 text-2xl align-middle mb-2 font-sans font-light">-</span>
          </h2>

          {/* Subtitle */}
          <p className="text-[#2d2219] text-base font-medium leading-relaxed mb-12 max-w-[380px]">
          ...
          <div className="flex items-start gap-8 md:gap-12 mb-14 w-full border-l border-[#c5a880]/30 pl-4 py-2 relative">
            ...
            <div className="flex flex-col items-center text-center gap-3">
              <div className="w-12 h-12 rounded-full border border-[#c5a880]/40 flex items-center justify-center shrink-0 text-[#9c1010]">
          ...
          <div className="flex items-center gap-6">
            <a href="#about" className="bg-[#9c1010] hover:bg-[#7a0c0c] text-white px-8 py-3.5 rounded-sm text-xs font-bold tracking-[2px] uppercase transition-colors flex items-center gap-3 shadow-md">
              Our Story
              <span>&rarr;</span>
            </a>
      ...
      <div className="relative w-full lg:w-[55%] min-h-[400px] lg:min-h-full bg-[#1a120b] overflow-hidden">
        ...
        {/* Floating Card */}
        <div className="absolute bottom-8 right-6 md:bottom-12 md:right-12 z-20 bg-[#faf6f0] p-5 md:p-6 rounded-sm shadow-2xl flex items-center gap-5 max-w-[320px]">
          <div className="w-12 h-12 rounded-full border border-primary/20 bg-white flex items-center justify-center shrink-0">
            <svg className="w-6 h-6 text-[#9c1010] fill-current" viewBox="0 0 24 24">
              <path d="M12 2C10 6 7 8 7 11.5c0 2.5 1.8 4.5 4.5 4.5S16 14 16 11.5C16 8 13 6 12 2zm1.8 11.2c-.3.4-.8.8-1.3 1-.3.1-.5.3-.5.5 0 .4.4.8.8.8.2 0 .4-.1.5-.2.5-.3 1-.8 1.2-1.4.1-.3-.2-.7-.7-.7z" />
            </svg>
          </div>
