  ...
  return (
    <section className="relative w-full h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1300px] mx-auto px-6 md:px-12 flex flex-col justify-center">
        ...
        {/* Subtitle / Script */}
        <h2 className="font-script text-4xl md:text-5xl text-[#c5a880] mb-2 -rotate-2 origin-left">
          Our Blog
        </h2>

        {/* Main Title */}
        <h1 className="font-serif text-5xl md:text-6xl lg:text-[5.5rem] font-medium text-white leading-[1.1] mb-6 max-w-2xl tracking-tight">
