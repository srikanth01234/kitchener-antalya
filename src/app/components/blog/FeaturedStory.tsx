...
export default function FeaturedStory() {
  return (
    <section className="relative w-full py-16 bg-[#faf6f0]">
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 flex flex-col lg:flex-row items-center justify-center relative">
        
        {/* Left Image Container */}
        <div className="relative w-full lg:w-[60%] z-10 flex-shrink-0">
          
          {/* Red Tag Overlapping */}
          <div className="absolute -top-4 -left-4 md:-top-6 md:-left-6 bg-[#9c1010] text-white z-20 px-6 py-6 md:px-8 md:py-8 rounded-md shadow-lg flex flex-col items-center justify-center">
        ...
        <div className="relative w-full lg:w-[45%] lg:-ml-24 z-20 mt-[-40px] lg:mt-0 px-4 md:px-0">
          ...
          <div className="bg-white rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.08)] p-8 md:p-12 lg:p-14 relative flex flex-col items-start border border-[#e5dacf]/30">
             ...
             {/* Category Tag */}
             <div className="flex items-center gap-2 text-[#9c1010] font-bold tracking-[2px] text-[10px] uppercase mb-5">
             ...
             {/* Title */}
             <h3 className="font-serif text-3xl md:text-4xl text-[#9c1010] font-medium leading-[1.2] mb-4">
               The Art of <br/> Turkish Tea
             </h3>

             {/* Date */}
             <div className="flex items-center gap-2 text-[#2d2219]/60 text-xs font-semibold mb-6">
             ...
             {/* Excerpt */}
             <p className="text-[#2d2219]/70 text-[14px] leading-relaxed mb-8 max-w-[340px]">
             ...
             {/* Link */}
             <Link href="#" className="flex items-center gap-2 text-[#9c1010] font-bold tracking-[2px] text-[11px] uppercase hover:text-[#7a0c0c] transition-colors">
               Read The Story
