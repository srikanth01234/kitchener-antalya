...
export default function BlogCTA() {
  return (
    <section className="w-full bg-[#faf6f0] py-16 px-6 md:px-12">
      <div className="max-w-[1300px] mx-auto bg-[#1a120b] rounded-xl overflow-hidden shadow-2xl relative flex flex-col lg:flex-row items-center">
        ...
        <div className="relative z-10 w-full lg:w-1/2 p-10 md:p-16 lg:p-20 flex flex-col items-start">
          ...
          {/* Eyebrow */}
          <span className="text-[#c5a880] font-bold tracking-[3px] text-[10px] uppercase mb-4">
            Stay Inspired
          </span>

          {/* Heading */}
          <h2 className="font-serif text-3xl md:text-5xl text-white font-medium leading-[1.2] mb-6">
          ...
          {/* Button */}
          <Link href="#" className="bg-[#9c1010] hover:bg-[#7a0c0c] text-white px-8 py-3.5 rounded-sm text-[11px] font-bold tracking-[2px] uppercase transition-colors flex items-center gap-3 shadow-md">
            Explore All Stories
        ...
        <div className="relative z-10 w-full lg:w-1/2 h-[350px] md:h-[420px] lg:h-[480px] overflow-hidden flex items-end justify-center py-0 px-4">
          ...
          <div className="relative w-full max-w-[450px] h-full mt-8 lg:mt-0 lg:ml-auto lg:mr-20">
            ...
            <div className="absolute bottom-[20px] lg:bottom-[35px] left-[2%] lg:left-[-2%] w-[150px] md:w-[185px] lg:w-[200px] aspect-[3/4] border-4 border-white rounded-sm shadow-xl transform -rotate-6 z-10 hover:z-40 hover:scale-105 transition-all duration-300">
               <img 
            ...
            <div className="absolute bottom-[40px] lg:bottom-[60px] left-[26%] lg:left-[24%] w-[170px] md:w-[205px] lg:w-[220px] aspect-[3/4] border-4 border-white rounded-sm shadow-2xl transform rotate-3 z-30 hover:scale-105 transition-all duration-300">
               <img 
            ...
            <div className="absolute bottom-[10px] lg:bottom-[20px] right-[2%] lg:right-[-2%] w-[150px] md:w-[185px] lg:w-[200px] aspect-[3/4] border-4 border-white rounded-sm shadow-xl transform rotate-12 z-20 hover:z-40 hover:scale-105 transition-all duration-300">
               <img 
