...
export default function BlogIntro() {
  return (
    <section className="relative w-full py-20 lg:py-28 bg-[#faf6f0] overflow-hidden">
      
      {/* Background Decorative Sketches */}
      <div className="absolute top-10 left-[-5%] w-[30%] opacity-10 pointer-events-none text-[#c5a880] select-none">
      ...
      <div className="absolute top-20 right-[-5%] w-[25%] opacity-10 pointer-events-none text-[#c5a880] select-none">
      ...
      <div className="relative z-10 max-w-[800px] mx-auto px-6 text-center flex flex-col items-center">
        ...
        {/* Top Tag */}
        <div className="flex items-center gap-3 text-[#c5a880] font-bold tracking-[3px] text-[11px] uppercase mb-6">
        ...
        {/* Heading */}
        <h2 className="font-serif text-4xl md:text-5xl lg:text-5xl text-[#2d2219] font-medium leading-[1.2] tracking-tight mb-8">
          Stories Crafted Through <br className="hidden md:block"/>
          <span className="text-[#9c1010]">Flavor & Celebration</span>
        </h2>

        {/* Paragraph */}
        <p className="text-[#2d2219]/80 text-[14px] md:text-[15px] leading-relaxed max-w-[600px] mx-auto font-medium">
