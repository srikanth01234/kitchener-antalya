...
const ContactFeatures = () => {
  ...
  return (
    <div 
      ref={containerRef}
      className={`w-full py-16 px-4 border-t border-[#e6e2d8] bg-[#fdfdfb] transition-all duration-700 ${isVisible ? 'is-visible' : ''}`}
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
        
        {/* Feature 1 */}
        <div className="flex flex-col items-center text-center gap-4 scroll-reveal-fade-up">
          ...
          <div>
            <h4 className="font-sans font-bold text-gray-900 text-sm uppercase tracking-widest mb-2">
              DINE-IN EXPERIENCE
            </h4>
        ...
        {/* Feature 2 */}
        <div 
          className="flex flex-col items-center text-center gap-4 scroll-reveal-fade-up"
