...
const ContactHeader = () => {
  return (
    <div className="w-full flex flex-col items-center text-center pt-20 pb-12 px-4">
      ...
      {/* Main Title */}
      <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl text-[#333] mb-6 tracking-wide">
      ...
      {/* Subtitle */}
      <p className="font-sans text-gray-500 text-sm md:text-base leading-relaxed max-w-xl mx-auto mb-6">
