...
export default function CateringEvents() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 right-0 lg:left-1/2 lg:-translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] lg:w-[700px] lg:h-[700px] pointer-events-none z-0 mix-blend-multiply scroll-reveal-bg-galata">
        <img 
          src="https://images.unsplash.com/photo-1541427468627-a14196e020cf?q=80&w=800&auto=format&fit=crop" 
          alt="" 
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-8 lg:px-12 flex flex-col lg:flex-row gap-16 lg:gap-8 items-center">
        ...
        <div className="w-full lg:w-1/2 relative flex flex-col min-h-[650px] lg:min-h-[750px]">
          ...
          {/* Top Red Ribbon */}
          <div className="absolute top-0 left-0 lg:left-6 z-30 w-16 lg:w-20 h-28 lg:h-32 bg-[#e10613] text-white flex flex-col items-center pt-3 lg:pt-4 shadow-lg scroll-reveal-ribbon" style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 50% 85%, 0 100%)" }}>
          ...
          {/* Floating Circle */}
          <div className="absolute top-[220px] lg:top-[300px] right-0 lg:right-[20px] w-36 h-36 lg:w-[200px] lg:h-[200px] rounded-full bg-[#faf6f0] border border-[#c5a880]/40 shadow-xl z-20 flex flex-col items-center justify-center text-center p-3 lg:p-4 scroll-reveal-float-circle">
            ...
            <span className="text-[11px] lg:text-[13px] font-extrabold text-[#2d2219] tracking-[2px] uppercase leading-relaxed">
              Good Food<br />Good People<br /><span className="text-[#e10613]">Great Memories</span>
            </span>
          </div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left mt-10 lg:mt-0 z-10 lg:pl-10">
          ...
          {/* Over-title */}
          <div className="flex items-center gap-3 text-[#e10613] font-extrabold tracking-[4px] text-xs uppercase mb-5 scroll-reveal-catering-right scroll-reveal-catering-title">
          ...
          {/* Main Title */}
          <h2 className="font-serif text-4xl md:text-5xl lg:text-[3.5rem] font-medium text-[#2d2219] leading-[1.1] mb-6 uppercase tracking-tight scroll-reveal-catering-right scroll-reveal-catering-head">
            Crafting Experiences, <br />
            <span className="text-[#e10613]">Creating Memories</span>
          </h2>

          <div className="w-full max-w-[200px] border-b border-[#c5a880]/40 mb-6 flex justify-center lg:justify-start relative scroll-reveal-catering-line">
            <div className="absolute top-[-4px] left-1/2 lg:left-[50px] -translate-x-1/2 w-2 h-2 rounded-full border border-[#c5a880]/40 bg-[#faf6f0] scroll-reveal-catering-dot" />
          </div>

          {/* Subtitle */}
          <p className="text-[#2d2219] text-base font-medium leading-relaxed mb-12 max-w-[480px] scroll-reveal-catering-right scroll-reveal-catering-sub">
          ...
          <div className="flex flex-col gap-6 lg:gap-8 w-full max-w-[500px]">
            {events.map((item, idx) => (
              <div key={idx} className={`flex items-center gap-5 lg:gap-6 group relative w-full text-left scroll-reveal-catering-row scroll-reveal-catering-row-${idx + 1}`}>
                <span className="font-serif text-4xl lg:text-5xl text-[#c5a880] italic w-12">{item.id}</span>

                <div className="w-14 h-14 lg:w-16 lg:h-16 rounded-full bg-[#faf6f0] shadow-[0_4px_15px_rgba(0,0,0,0.05)] border border-[#c5a880]/20 flex items-center justify-center text-[#e10613] shrink-0 group-hover:scale-105 transition-transform duration-300">
                  {item.icon}
                </div>
                ...
                <div className="hidden lg:flex flex-1 items-center overflow-hidden">
                  <div className="h-[1px] w-full border-b border-dashed border-[#c5a880]/40 group-hover:border-[#e10613]/50 transition-colors dashed-line-expand" />
                  <div className="w-1.5 h-1.5 rounded-full bg-[#e10613] ml-2 shrink-0 opacity-60 group-hover:opacity-100 transition-opacity dot-pop-end" />
                </div>
              </div>
            ))}
          </div>
          ...
          {/* Action Button */}
          <div className="mt-14 w-full flex justify-center lg:justify-start scroll-reveal-catering-right scroll-reveal-catering-action">
            <button className="border-2 border-[#c5a880] hover:border-[#e10613] text-[#e10613] hover:bg-[#e10613] hover:text-white px-10 py-3.5 rounded-sm text-xs font-extrabold tracking-[3px] uppercase transition-all duration-300 flex items-center gap-3 shadow-sm hover:shadow-md">
              Plan Your Event
              <span>&rarr;</span>
            </button>
          </div>
