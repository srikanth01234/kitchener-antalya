          ...
          >
            ...
            <Link href="/" className="flex items-center group shrink-0 z-10">
              <img
                ...
                className="h-13 md:h-13 lg:h-16 w-auto object-contain transition-all duration-300 group-hover:scale-105"
              />
            </Link>
 
            {/* ── Vertical Divider ── */}
            <div
              className={`hidden md:block self-stretch w-px my-2 mx-2 lg:mx-6 shrink-0 ${isScrolled ? "bg-white/15" : "bg-[#2d2219]/15"
                }`}
            />
 
            {/* ────────────── CENTER: Nav Links ────────────── */}
            <nav className="hidden md:flex items-center gap-2.5 lg:gap-7 flex-1 justify-center z-10">
              {navLinks.map((link) => {
                ...
                return (
                  <Link
                    key={link.label}
                    href={link.href}
                    className={`relative font-sans text-[10px] lg:text-xs font-bold tracking-[0.05em] lg:tracking-[0.18em] uppercase py-1.5 transition-colors duration-200 group/link ${active
                      ? "text-[#e10613]"
                      : isScrolled
            ...
            <div className="flex items-center gap-3 z-10 shrink-0">
              ...
              <Link
                href="/contact"
                className="hidden sm:flex items-center gap-1.5 md:gap-2 bg-[#e10613] hover:bg-[#c00510] text-white text-[9px] md:text-[10px] lg:text-xs font-bold tracking-[0.08em] lg:tracking-[0.18em] uppercase px-2.5 md:px-4 lg:px-5 py-2 md:py-2.5 lg:py-3 rounded-lg shadow-md transition-all duration-300 hover:shadow-[0_4px_18px_rgba(225,6,19,0.35)] hover:scale-[1.02]"
              >
