...
const features: FeatureItem[] = [
  ...
  },
  {
    ...
    desc: "Great food, beautiful ambience, and moments you'll cherish.",
    icon: (
      <svg className="w-4 h-4 fill-none stroke-current" strokeWidth="2.5" viewBox="0 0 24 24">
...
export default function AboutWhyChooseUs() {
  return (
    <section className="relative w-full py-20 lg:py-28 bg-[#faf6f0] text-[#2d2219] overflow-hidden">
      ...
      <div className="border border-[#c5a880]/30 rounded-[2.5rem] p-8 lg:p-14 relative w-full max-w-5xl mx-auto z-10 bg-white/10 backdrop-blur-[2px]">
        
        {/* Rosette Absolute Badge Centered on Top Border */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#faf6f0] px-4 py-1 z-20 text-[#c5a880]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center text-left">
            ...
            {/* Title */}
            <h2 className="font-serif text-4xl sm:text-5xl text-[#2d2219] font-medium leading-none tracking-tight mb-6">
              WHY <span className="text-[#9c1010]">CHOOSE US</span>
            </h2>
            ...
            {/* Copy */}
            <div className="flex flex-col gap-4 font-sans text-[#2d2219]/80 text-sm sm:text-base leading-relaxed mb-8 font-medium">
              <p>
              ...
              {features.map((feature, idx) => (
                <div key={idx} className="flex gap-4 items-start">
                  ...
                  <div className="flex flex-col text-left">
                    <span className="font-sans font-extrabold text-[10px] text-[#9c1010] tracking-[1.5px] uppercase">
                      {feature.title}
                    </span>
          ...
          <div className="lg:col-span-6 flex items-center justify-center relative w-full h-[450px] sm:h-[500px]">
            ...
            {/* Watermarks */}
            <div className="absolute top-4 right-[10%] opacity-25 select-none pointer-events-none">
            ...
            <div className="absolute bottom-4 left-[5%] opacity-25 select-none pointer-events-none">
            ...
            {/* Main Arch Image */}
            <div className="absolute top-[20px] left-[5%] w-[75%] aspect-[1/1.1] rounded-t-full border border-[#c5a880]/15 overflow-hidden z-10 shadow-lg">
              <img 
            ...
            <div className="absolute bottom-[20px] right-[2%] w-[45%] aspect-[1/1.1] rounded-t-full rounded-br-2xl border-2 border-white overflow-hidden z-20 shadow-2xl">
              <img 
            ...
            <div className="absolute bottom-[60px] left-[5%] w-24 h-24 sm:w-28 sm:h-28 z-25 drop-shadow-xl select-none pointer-events-none">
              <div className="w-full h-full rounded-full bg-[#7a0c0c] border-4 border-[#faf6f0] flex flex-col items-center justify-center relative p-2 animate-[spin_60s_linear_infinite]">
                {/* Circular text */}
