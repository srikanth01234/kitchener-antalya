...
export default function Home() {
  return (
    <div id="home" className="relative min-h-screen bg-[#faf6f0] text-[#2d2219] flex flex-col justify-between overflow-x-hidden font-sans selection:bg-primary selection:text-white">
      ...
      {/* --- HERO SECTION --- */}
      <main className="relative flex-1 w-full flex flex-col lg:flex-row items-center overflow-visible z-20">
                ...
                <span className="hero-line-2">
                  ...
                  <span className="text-primary italic relative inline-block hero-fire-glow">
                    ...
                    <span className="absolute -bottom-2 left-0 right-0 h-1.5 flex items-center">
                      <svg className="w-full h-full text-primary draw-underline" viewBox="0 0 120 8" fill="none" preserveAspectRatio="none">
                        <path
        ...
        {/* Right Column: Extended bottom length and aligned to the bottom to match the curve design */}
        <div className="w-full lg:w-[56%] xl:w-[60%] h-[400px] lg:h-[550px] xl:h-[620px] relative overflow-visible z-10 lg:self-end flex items-stretch lg:-ml-[8vw] xl:-ml-[8vw] lg:-mb-24 xl:-mb-32">
          <HeroRight />
        </div>
      ...
      <div className="relative w-full overflow-visible h-14 md:h-18 z-40">
        <svg viewBox="0 0 1440 60" className="w-full overflow-visible absolute -bottom-1 left-0">
          {/* Solid cream background fill below the curve line to mask overlapping elements */}
          <path
            d="M 0 40 C 360 75, 540 10, 720 10 C 900 10, 1080 75, 1440 40 L 1440 100 L 0 100 Z"
            fill="#faf6f0"
          />
          <path
